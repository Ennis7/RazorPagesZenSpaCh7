    ...
    public partial class ClientAndAnnotations : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 1, new DateTime(2024, 10, 22, 23, 45, 25, 654, DateTimeKind.Local).AddTicks(5831), 1 },
                    { 2, 2, new DateTime(2024, 10, 22, 23, 45, 25, 654, DateTimeKind.Local).AddTicks(5867), 7 },
                    { 3, 1, new DateTime(2024, 10, 22, 23, 45, 25, 654, DateTimeKind.Local).AddTicks(5869), 5 }
                });
