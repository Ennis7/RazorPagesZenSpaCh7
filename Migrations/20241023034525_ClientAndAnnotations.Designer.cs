...
namespace RazorPagesZenSpaCh7.Migrations
{
    ...
    [Migration("20241023034525_ClientAndAnnotations")]
            ...
            modelBuilder.Entity("RazorPagesZenSpaCh7.Models.ClientService", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ID = 1,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 22, 23, 45, 25, 654, DateTimeKind.Local).AddTicks(5831),
                            ServicesID = 1
                        },
                        new
                        {
                            ID = 2,
                            ClientID = 2,
                            Date = new DateTime(2024, 10, 22, 23, 45, 25, 654, DateTimeKind.Local).AddTicks(5867),
                            ServicesID = 7
                        },
                        new
                        {
                            ID = 3,
                            ClientID = 1,
                            Date = new DateTime(2024, 10, 22, 23, 45, 25, 654, DateTimeKind.Local).AddTicks(5869),
                            ServicesID = 5
                        });
                });
